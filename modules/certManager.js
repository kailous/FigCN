...
async function installToLogin(certPath) {
  ...
  return { ok: true, installedTo: "login", message: "证书已安装到 login 钥匙串，并设为受信任根。" };
}
...
async function installToSystemWithOSA(certPath) {
  ...
  return { ok: true, installedTo: "system", message: "证书已安装到 System 钥匙串。" };
}
...
// 手动安装/信任的提示文本
function buildManualSteps(certPath) {
  return [
    "自动安装失败，请手动安装并信任证书：",
